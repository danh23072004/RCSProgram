...
{
    /// <summary>
    /// This class is used for storing constant value in project
    /// </summary>
    class Constant
    {
        public static string[] arrNuclide = new string[5]
        {
            "F-18", "I-131", "Lu-177", "Tc-99m", "Y-90",
        };

        public static int[] malePhantom = { 0, 2, 3, 4, 5, 6 };
        public static int[] femalePhantom = { 1, 7, 8, 9, 10, 11, 12, 13, 14 };
        public static int[] placentaFemalePhantom = { 13, 14 };
